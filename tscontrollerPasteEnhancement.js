...
Ext.define('TS.view.editing.classes.tscontrollerPasteEnhancement', {
    ...
    ExtractDataFromClipboard: async function () {
        ...
        Ext.defer(function () {
            ...
            let LExtractedDataArr = gtsCommonUtils().SplitDataUsingInputFormatters(LDataFromClipboardObj.text, LSplitterContraints, LIsCopiedDataHtml);
